...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    rinkeby: {
      url: 'https://rinkeby.infura.io/v3/ca11d2a86d8e493798c1f7469e7a2a5e', // <---- YOUR INFURA ID! (or it won't work)
      gasMultiplier: 10,
      gas: 15000000,
    ...
    kovan: {
      url: 'https://kovan.infura.io/v3/ca11d2a86d8e493798c1f7469e7a2a5e', // <---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: getMnemonic(),
      },
    },
    mainnet: {
      url: 'https://mainnet.infura.io/v3/ca11d2a86d8e493798c1f7469e7a2a5e', // <---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: getMnemonic(),
      },
    },
    ropsten: {
      url: 'https://ropsten.infura.io/v3/ca11d2a86d8e493798c1f7469e7a2a5e', // <---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: getMnemonic(),
      },
    },
    goerli: {
      url: 'https://goerli.infura.io/v3/ca11d2a86d8e493798c1f7469e7a2a5e', // <---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: getMnemonic(),
      },
    },
